...
const SunIcon = () => (
  <Icon d="M12 3v1m0 16v1m9-9h-1M4 12H3m15.364-6.364l-.707.707M6.343 17.657l-.707.707m12.728 0l-.707-.707M6.343 6.343l-.707-.707M12 8a4 4 0 1 0 0 8 4 4 0 0 0 0-8z" />
);
      ...
      <header className="lp-nav">
        ...
        {menuOpen && (
          <nav className="lp-mobile-nav" aria-label="Mobile navigation">
            ...
            <Link
              to="/login"
              className="lp-btn lp-btn--primary lp-mobile-login"
              onClick={() => setMenuOpen(false)}
            >
              Login
            </Link>
      ...
      <main>
        ...
        <section className="lp-hero" id="hero" aria-labelledby="hero-heading">
          ...
          <div className="lp-container lp-hero__content">
            ...
            <p className="lp-hero__sub">
              Smart Campus unifies resource booking, facility ticketing, and campus communications
              into one elegant, powerful platform — designed for students and administrators alike.
            </p>
              ...
              <div className="lp-mockup__body">
                <div className="lp-mockup__sidebar">
                  {['Dashboard', 'Resources', 'Bookings', 'Tickets', 'Admin'].map((item) => (
                    <div key={item} className="lp-mockup__nav-item">
                      {item}
                    </div>
                  ))}
                </div>
        ...
        <section className="lp-stats" id="stats" aria-labelledby="stats-heading">
          <div className="lp-container">
            <h2 id="stats-heading" className="lp-visually-hidden">
              Campus Statistics
            </h2>
          ...
          <div className="lp-container">
            <div className="lp-section-header">
              ...
              <p className="lp-section-sub">
                From booking a lecture hall to tracking a maintenance request — Smart Campus handles
                it all with elegance and efficiency.
              </p>
            </div>
        ...
        <section className="lp-about" id="about" aria-labelledby="about-heading">
          <div className="lp-container lp-about__inner">
            <div className="lp-about__text">
              ...
              <h2 id="about-heading" className="lp-section-title">
                Built for modern campuses.
              </h2>
              <p>
                Smart Campus is an integrated operations hub developed to streamline university
                administration. Administrators have complete control over resources, students, and
                facilities — while students enjoy a seamless, intuitive interface to interact with
                campus services.
              </p>
              <p>
                With no open sign-ups, access is securely managed by your campus administrator,
                ensuring data integrity and a trusted community on the platform.
              </p>
        ...
        <section className="lp-cta" id="contact" aria-labelledby="cta-heading">
          ...
          <div className="lp-container lp-cta__inner">
            ...
            <p className="lp-cta__sub">
              Log in with your campus credentials to get started. Need an account? Contact your
              administrator.
            </p>
